...
const Skills = () => {
    return (
        <section id="skills" className="container mx-auto p-5">
            <h2 className="mb-3 text-start"><span className="text-xl">My Arsenal</span> <br /><span className="font-extrabold text-gray-950 dark:text-gray-100 text-3xl md:text-5xl mb-2 tracking-tight text-start">Skills</span></h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8">
                ...
                <div className="my-5 shadow-md dark:bg-zinc-900 bg-zinc-100 rounded-xl border-2 border-solid border-zinc-400 dark:border-zinc-700 hover:border-zinc-600 dark:hover:border-white  transform hover:scale-103 transition-transform px-5 pt-5">
                    ...
                    <div className="grid grid-cols-4 md:grid-cols-5 gap-12 my-4">
                        <div>
                            <img className="" src="/public/firebase-1.svg" alt="" />
                        </div>
                        <div>
