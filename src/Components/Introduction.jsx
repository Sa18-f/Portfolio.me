...
const Introduction = () => {
    return (
        <section className="container lg:my-12 my-2 mx-auto p-2">
            <div className="flex justify-between items-center gap-4 lg:flex-row flex-col">
                <div className="text-start">
                    <h1 className="text-gray-950 dark:text-gray-100 text-3xl md:text-5xl font-bold mb-2 tracking-tight">Md.  Shoriful  Islam</h1>
                    <p className="text-lg mt-2">• Student • Web Developer</p>
                    <p className="text-gray-800 dark:text-gray-200 text-xl md:text-2xl tracking-tight mt-2 lg:mt-5">I'm a passionate web developer, creating my unique digital world step by step. I'm currently pursuing an undergraduate course in engineering while developing websites and playing games in free time.</p>
                    <p className="text-gray-600 dark:text-gray-400 text-xl md:text-2xl mt-4 tracking-tight">Connect with me here! ⬇️</p>
                    <div className="mt-8 flex flex-wrap gap-5  mb-16">
                        <a href="https://github.com/Sa18-f" aria-label="GitHub" className="dark:fill-white fill-black transition-transform hover:scale-150">
                        ...
                        <a href="https://www.linkedin.com/in/md-shoriful-islam-169722316/" aria-label="LinkedIn" className="dark:fill-white  transition-transform hover:scale-150 fill-black">
                            <svg width="30" height="30" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <img className="rounded-xl transition-transform hover:scale-125" src="https://i.ibb.co/sKDPvLK/Whats-App-Image-2024-07-04-at-02-13-46-1ce1c470.jpg" alt="" />
                </div>
            </div>
        </section>
    );
