    ...
    return (
        <div className="my-12 text-start flex lg:flex-row flex-col-reverse justify-between items-center gap-6 mx-auto container p-2">
            ...
            <div className="">
                ...
                <div className="flex gap-7 items-center flex-wrap"><div><span className="blue-text-gradient cursor-help font-bold lg:text-[44px] text-[30px]"><span>20</span></span><br /><span className="text-gray-400 font-semibold lg:text-normal text-sm">years old</span></div><div><span className="blue-text-gradient  cursor-help font-bold lg:text-[44px] text-[30px]"><span>8</span>+</span><br /><span className="text-gray-400 font-semibold lg:text-normal text-sm">Months web dev </span></div><div><span className="blue-text-gradient cursor-help font-bold lg:text-[44px]  text-[30px]"><span>562</span></span><br /><span className="text-gray-400 font-semibold lg:text-normal text-sm">Total Commits</span></div></div>
                <h3 className="text-2xl font-medium text-[#0788FF] mt-3">Front End Web Developer</h3>
